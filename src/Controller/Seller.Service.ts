...
const AddCategory = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, " Category Added Successfully", {
        category,
      });
    } catch (error) {
...
const GetCategoryList = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      const list = await prisma.category.findMany({ skip: skip, take: limit });
      SuccessHandler.sendSuccessResponse(res, "List of category is :", {
        list,
        page: page,
...
const updatecategory = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "Updated successfully", {
        update,
      });
    } catch (error: any) {
      res
...
const deleteCategory = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "Category deleted successfully", {
        deletedCategory,
      });
    } catch (error: any) {
...
const AddPrduct = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "Product Added Successfully", {
        newProduct,
      });
    } catch (error: any) {
...
const UpdateProduct = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "Product updated successfully", {
        updatedProduct,
      });
    } catch (error: any) {
...
const deleteProduct = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "product deleted successfully", {
        deleteProduct,
      });
    } catch (error: any) {
...
const AddProductImage = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        uploadPromises.push(
          new Promise<UploadApiResponse>((resolve, reject) => {
            cloudinary.uploader.upload(
              file.path,
              async (err: any, result: UploadApiResponse) => {
                if (err) {
                  ...
                  try {
                    ...
                    console.error(
                      "Error saving product image to database:",
                      error
                    );
                    reject(error);
                  }
      ...
      SuccessHandler.sendSuccessResponse(
        res,
        "Product image's inserted successfully"
      );
    } catch (error: any) {
...
const GetAllproducts = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "List of products are :", {
        getAll,
        page: page,
        totalPages: totalPages,
      });
...
const filter = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "filtered data", {
        filteredProducts,
      });
    } catch (error: any) {
...
const GetOrdersByStatus = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    const page = parseInt(req.query.page as string) || 1;
    ...
    try {
      ...
      SuccessHandler.sendSuccessResponse(
        ...
        { orders, totalPages: totalPages, page: page }
      );
    } catch (error: any) {
      res
        .status(500)
...
const orderConfirmation = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      SuccessHandler.sendSuccessResponse(res, "Order : approved");
    } catch (error: any) {
...
const declineorderConfirmation = expressAsyncHandler(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const orderId = req.query.orderId as string;
      console.log(orderId);
      ...
      SuccessHandler.sendSuccessResponse(res, "Order : Rejected");
    } catch (error: any) {
      console.error("Error approving order:", error);
      res
        .status(500)
