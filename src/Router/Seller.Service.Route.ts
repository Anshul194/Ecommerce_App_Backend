...
import {AddPrduct,AddProductImage,GetAllproducts,AddCategory,GetCategoryList,updatecategory,deleteCategory,
    deleteProduct,UpdateProduct,orderConfirmation,declineorderConfirmation,GetOrdersByStatus,filter} from "../Controller/Seller.Service";
